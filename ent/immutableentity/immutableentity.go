...
const (
	// Label holds the string label denoting the immutableentity type in the database.
	Label = "immutable_entity"
	...
	// Table holds the table name of the immutableentity in the database.
	Table = "immutable_entities"
)

// Columns holds all SQL columns for immutableentity fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
func SourceValidator(s Source) error {
	...
	case SourceUser, SourceAgent, SourceImport, SourceSystem, SourceMigration:
		return nil
	default:
		return fmt.Errorf("immutableentity: invalid enum value for source field: %q", s)
	}
}

// OrderOption defines the ordering options for the ImmutableEntity queries.
