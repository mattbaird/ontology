...
func init() {
	...
	leaseDescBaseRentCurrency := leaseFields[8].Descriptor()
	...
	leaseDescSecurityDepositCurrency := leaseFields[10].Descriptor()
	...
	ledgerentryDescReconciled := ledgerentryFields[12].Descriptor()
	...
	// unitDescCreatedBy is the schema descriptor for created_by field.
	unitDescCreatedBy := unitMixinFields0[2].Descriptor()
	// unit.CreatedByValidator is a validator for the "created_by" field. It is called by the builders before save.
	unit.CreatedByValidator = unitDescCreatedBy.Validators[0].(func(string) error)
	// unitDescUpdatedBy is the schema descriptor for updated_by field.
	unitDescUpdatedBy := unitMixinFields0[3].Descriptor()
	// unit.UpdatedByValidator is a validator for the "updated_by" field. It is called by the builders before save.
	unit.UpdatedByValidator = unitDescUpdatedBy.Validators[0].(func(string) error)
	// unitDescAdaAccessible is the schema descriptor for ada_accessible field.
	unitDescAdaAccessible := unitFields[10].Descriptor()
	// unit.DefaultAdaAccessible holds the default value on creation for the ada_accessible field.
	unit.DefaultAdaAccessible = unitDescAdaAccessible.Default.(bool)
	// unitDescPetFriendly is the schema descriptor for pet_friendly field.
	unitDescPetFriendly := unitFields[11].Descriptor()
	// unit.DefaultPetFriendly holds the default value on creation for the pet_friendly field.
	unit.DefaultPetFriendly = unitDescPetFriendly.Default.(bool)
	// unitDescFurnished is the schema descriptor for furnished field.
	unitDescFurnished := unitFields[12].Descriptor()
	// unit.DefaultFurnished holds the default value on creation for the furnished field.
	unit.DefaultFurnished = unitDescFurnished.Default.(bool)
	// unitDescMarketRentCurrency is the schema descriptor for market_rent_currency field.
	unitDescMarketRentCurrency := unitFields[14].Descriptor()
	// unit.DefaultMarketRentCurrency holds the default value on creation for the market_rent_currency field.
	unit.DefaultMarketRentCurrency = unitDescMarketRentCurrency.Default.(string)
	// unit.MarketRentCurrencyValidator is a validator for the "market_rent_currency" field. It is called by the builders before save.
	unit.MarketRentCurrencyValidator = unitDescMarketRentCurrency.Validators[0].(func(string) error)
