...
const (
	// Label holds the string label denoting the baseentity type in the database.
	Label = "base_entity"
	...
	// Table holds the table name of the baseentity in the database.
	Table = "base_entities"
)

// Columns holds all SQL columns for baseentity fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
func SourceValidator(s Source) error {
	...
	case SourceUser, SourceAgent, SourceImport, SourceSystem, SourceMigration:
		return nil
	default:
		return fmt.Errorf("baseentity: invalid enum value for source field: %q", s)
	}
}

// OrderOption defines the ordering options for the BaseEntity queries.
